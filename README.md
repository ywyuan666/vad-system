...
专为社招面试准备的 **完整 PDF 文档** `docs/interview_prep.pdf`，包含:

| 章节 | 内容 |
|------|------|
| **第1章** | 项目自我介绍 (30秒/1分钟/3分钟版本) |
| **第2章** | 整体架构与核心模块 (五层架构/数据流/方法对比) |
| **第3章** | 九大架构决策记录 (ADR) — 面试深挖必问 |
| **第4章** | 面试官常问 50 问 (基础/算法/工程/系统/进阶) |
| **第5章** | 深挖追问清单 — 穿透式追问准备 |
| **第6章** | 面试场景题 (线上排查/数据不足/低资源部署) |
| **第7章** | 面试展示策略 (消融实验/Grad-CAM/ASR评估) |
| **第8章** | 准备清单 & 话术速查 (反问问题/回答框架) |

> **面试前必读**: 建议至少通读 2 遍，重点记忆 ADR (第3章) 和 50 问 (第4章)。
